...
void inserir() {
    ...
    printf("Rua:");
    gotoxy(10, 8);
    scanf("%s", & ag[i].end.rua);
    gotoxy(5, 10);
    printf("Numero:");
    gotoxy(13, 10);
    scanf("%i", & ag[i].end.num);
    gotoxy(5, 12);
    printf("Bairro:");
    gotoxy(13, 12);
    scanf("%s", & ag[i].end.bairro);
    gotoxy(5, 14);
    printf("Cidade:");
    gotoxy(13, 14);
    scanf("%s", & ag[i].end.cidade);
    gotoxy(5, 16);
    printf("CEP:");
    gotoxy(10, 16);
    scanf("%i", & ag[i].end.cep);
}
...
void mostrartudo() {
    ...
    gotoxy(5, 8);
    printf("Rua: %s", ag[i].end.rua);
    gotoxy(5, 10);
    printf("Número: %i", ag[i].end.num);
    gotoxy(5, 12);
    printf("Cidade: %s", ag[i].end.cidade);
    gotoxy(5, 14);
    printf("Bairro: %s", ag[i].end.bairro);
    gotoxy(5, 16);
    printf("CEP:    %i", ag[i].end.cep);
}
